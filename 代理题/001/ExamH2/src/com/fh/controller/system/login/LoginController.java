...
import com.fh.entity.H2Test;
import com.fh.entity.H2TestGet;
...
public class LoginController extends BaseController {
	...
	public ModelAndView toLogin()throws Exception{
		...
		PageData pd = new PageData();
		List<H2Test> h2TestList = h2TestGet.findList(new H2Test());
		mv.addObject("h2TestList", h2TestList);
		mv.setViewName("system/admin/h2");
